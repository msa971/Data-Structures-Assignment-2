...
class Hospital:
    ...
    def update_record(self, patient_id, updated_details):  # function to update the record of a patient.
        if patient_id in self.patients:  # checks if the given patient ID is found then updates the records.
            patient = self.patients[patient_id]
            patient.name = updated_details.get('name', patient.name)
            patient.medical_record = updated_details.get('medical_record', patient.medical_record)
            patient.current_diagnosis = updated_details.get('current_diagnosis', patient.current_diagnosis)
